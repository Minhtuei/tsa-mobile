    ...
    <Controller
      render={({ field }) => (
        <>
          ...
          />
          {errors.lastName && (
            <Text style={globalStyles.error}>{errors.lastName.message}</Text>
          )}
        </>
      )}
      control={control}
    ...
    <Controller
      render={({ field }) => (
        <View style={globalStyles.input}>
          ...
          />
          {errors.dormitory && (
            <Text style={globalStyles.error}>{errors.dormitory.message}</Text>
          )}
        </View>
      )}
      control={control}
    ...
    <Controller
      render={({ field }) => (
        <View style={globalStyles.input}>
          ...
          />
          {errors.room && (
            <Text style={globalStyles.error}>{errors.room.message}</Text>
          )}
        </View>
      )}
      control={control}
    ...
    <Controller
      render={({ field }) => (
        <View style={globalStyles.input}>
          ...
          />
          {errors.building && (
            <Text style={globalStyles.error}>{errors.building.message}</Text>
          )}
        </View>
      )}
      control={control}
